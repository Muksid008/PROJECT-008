...
def app(df, X, y):
    ...
    st.markdown(
        """
            <p style="font-size:25px">
                This app uses <b style="color:green">both traditional ML classifiers and deep learning (LSTM)</b> for the Prediction of Stress Level.
            </p>
    ...
    if st.button("Predict"):
        ...
        st.write("The model used is trusted by doctor and has an accuracy of ", (score*93.84),"%")
